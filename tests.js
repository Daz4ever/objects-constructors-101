describe('Card', function () {
  ...
  describe('Hand', function () {
    ...
    it('should instantiate a new hand with an empty array that we can add cards to', function() {
      var NewHand = new Hand();
      card = new Card(5, 'hearts');
      NewHand.addCard(card);
      expect(NewHand.hand).toEqual([card]);
    });

    // it('should instantiate a new hand with an empty array that we can add cards to', function() {
    //   var NewHand = new Hand();
    //   card = new Card(11, 'hearts');
    //   expect(NewHand.addCard(card)).toEqual([{point: 11, suit: 'hearts'}]);
    // });
  });
